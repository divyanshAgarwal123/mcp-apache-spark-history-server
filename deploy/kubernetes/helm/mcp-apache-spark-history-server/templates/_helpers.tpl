...
Use the release name by default so the chart's long name is not repeated in every
resource name. Keep the standard Helm override behavior when nameOverride or
fullnameOverride is explicitly configured.
